...
def generate_response(qa_result):
    ...
    if source_documents:
        ...
        for doc in source_documents:
            # Ensure metadata exists and has a 'source' key
...
if __name__ == "__main__":
    # This part is for standalone testing, which we are not doing in the main flow.
    # It would need a mock 'qa' object and a question to run.
    pass