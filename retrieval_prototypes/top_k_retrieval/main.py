...
from vectorization.main import main as vectorization_main
...
def main():
    parser = argparse.ArgumentParser(description="RAG-based Code Expert Agent")
    parser.add_argument("question", type=str, help="The question to ask the agent.")
    args = parser.parse_args()

    # Load model names from the central config file
